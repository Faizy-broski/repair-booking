-- ============================================================
-- 079 — process_refund: stop marking original sale as 'refunded'
-- The refund record (is_refund=true) is its own accounting entry.
-- The original sale was a real completed payment and stays 'paid'.
-- ============================================================
...
BEGIN
  ...
  -- Original sale status is intentionally NOT updated.
  -- The original sale was a completed payment (paid) and remains so.
  -- The refund record (is_refund=true) is the separate accounting entry.
