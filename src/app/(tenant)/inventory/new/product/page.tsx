    ...
    <div className="flex min-h-screen flex-col">
      <div className="sticky top-0 z-30 flex flex-col sm:flex-row sm:items-center justify-between border-b border-outline-variant bg-surface px-4 sm:px-6 py-3 gap-3 sm:gap-0">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <span className="text-sm font-medium text-on-surface truncate">Add New Product</span>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-[76px]">
              ...
              <SectionCard title="Stock">
                ...
                {hasVariants && (
                  <p className="text-xs text-on-surface-variant rounded-lg border border-dashed border-outline-variant px-3 py-2">
              ...
              <SectionCard title="Pricing Options">
                <div className="rounded-lg border border-outline-variant">
                  <div className="flex items-center justify-between px-4 py-3">
                    <div>
                      ...
                      <p className="text-xs text-on-surface-variant">Enable employee commission for this product</p>
                    </div>
                ...
                <div className="flex items-center justify-between rounded-lg border border-outline-variant px-4 py-3">
                  <div>
                    ...
                    <p className="text-xs text-on-surface-variant">Earn / redeem loyalty points on this product</p>
                  </div>
                    ...
                    <div className="rounded-lg border border-outline-variant overflow-x-auto">
                      <table className="w-full divide-y divide-outline-variant text-sm">
                        <thead className="bg-surface-container-low">
                          <tr>
                            {!hasRepairs && <th className="px-4 py-3 text-left text-sm font-semibold text-on-surface-variant">Image</th>}
                            ...
                            <th className="px-4 py-3 text-left text-sm font-semibold text-on-surface-variant">Selling Price ({currSymbol}) *</th>
                        ...
                        <tbody className="divide-y divide-outline-variant bg-surface">
                          {variantRows.map(row => (
                            <tr key={row.key} className="hover:bg-surface-container-low/60 align-middle">
                              ...
                              <td className="px-4 py-3">
                                <input type="text" value={row.sku} onChange={e => updateVariantRow(row.key, 'sku', e.target.value)} placeholder="Optional" className="w-24 rounded-lg border border-outline-variant px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal" />
                              </td>
                              <td className="px-4 py-3">
                              ...
                              <td className="px-4 py-3">
                                <input type="number" min="0" step="0.01" value={row.costPrice} onChange={e => updateVariantRow(row.key, 'costPrice', e.target.value)} placeholder="0.00" className="w-24 rounded-lg border border-outline-variant px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal" />
                              </td>
                              <td className="px-4 py-3">
                                <input type="number" min="0" step="0.01" value={row.sellingPrice} onChange={e => updateVariantRow(row.key, 'sellingPrice', e.target.value)} placeholder="0.00" className={`w-24 rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal ${!row.sellingPrice ? 'border-red-300 bg-red-50' : 'border-outline-variant'}`} />
                              </td>
                              <td className="px-4 py-3">
                                <input type="number" min="0" value={row.stock} onChange={e => updateVariantRow(row.key, 'stock', e.target.value)} className="w-20 rounded-lg border border-outline-variant px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-teal/30 focus:border-brand-teal" />
                              </td>
                              <td className="px-4 py-3">
