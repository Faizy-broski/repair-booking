...
import type { IndustryPage } from "@/lib/footer-pages";
...
export default function IndustryPageTemplate({ page }: { page: IndustryPage }) {
  return (
    <PageShell>
        ...
        <div className="mx-auto max-w-7xl">
          <FadeIn className="mb-10 sm:mb-14">
            <h2 className="max-w-2xl text-2xl font-medium tracking-[-0.02em] text-slate-950 sm:text-4xl">
              The challenges {page.name.toLowerCase()} shops face
            </h2>
          </FadeIn>
        ...
        <div className="mx-auto max-w-5xl">
          <FadeIn className="mb-10 text-center sm:mb-14">
            <h2 className="text-2xl font-medium tracking-[-0.02em] text-slate-950 sm:text-4xl">
              A typical {page.name.toLowerCase()} workflow
            </h2>
          </FadeIn>
      ...
      <CtaSection
        heading={`Run your ${page.name.toLowerCase()} shop smarter.`}
        scriptWord="smarter."
      />

      <RelatedLinks heading="Related industries & tools" links={page.related} />
    </PageShell>
  );
}
